...
- Azure Container App to host the 'ai-search-indexing-function' service.
- Azure Container App to host the 'document-intelligence-function' service.
- Azure Container App to host the 'document-queueing-function' service.
- Azure Container App to host the 'processed-file-mover' service.
- Azure Container App to host the 'custom-field-extraction-function' service.
- Azure Container App to host the 'document-questions-function' service.
