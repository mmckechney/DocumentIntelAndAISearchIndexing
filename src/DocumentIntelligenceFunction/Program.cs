...
builder.Services.AddSingleton<Tracker<DocIntelligence>>();
builder.Services.AddSingleton<CosmosDbHelper>();
builder.Services.AddSingleton<DocIntelligence>();
builder.Services.AddHostedService<DocIntelligenceWorker>();
