...
namespace HighVolumeProcessing.ProcessedFileMover
{
   public class FileMover
   {
      ...
      public async Task<bool> CleanupFolder()
      {
         ...
         var blobList = storageHelper.GetContainerClient(settings.SourceContainerName).GetBlobsAsync(new Azure.Storage.Blobs.Models.GetBlobsOptions { Traits = BlobTraits.Metadata });
